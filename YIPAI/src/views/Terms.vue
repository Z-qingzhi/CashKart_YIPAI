		...
		<div class="container">
			<div class="content">
				<div class="ypMain middleBox">
					<h1>TERMS AND CONDITIONS ON THE LOAN </h1>
					<p>In using www.lalapeso.com, including any of its sub-domains (the "Website and Lalapeso app"), you signify that you have read, understood, and agreed to be bound by all of the Terms & Conditions below, whether or not you are a registered member of the Website.</p>
					<p class="termandcondition__subtitle">1. LOAN AMOUNT</p>
					<p>The Lender has agreed to lend to the Borrower the amount stipulated in the Disclosure Statement, in Philippine Currency (the “Loan” or the “Personal Loan”).</p>

					<p class="termandcondition__subtitle">2. PURPOSE</p>
					<p>The Borrower undertakes to use the Loan, or any portion thereof, for legitimate and legal purposes only, and shall not be used for any purpose, or in any endeavor, which is against Philippine laws, rules, and regulations.</p>

					<p class="termandcondition__subtitle">3. TERM</p>
					<p>The Loan shall have a term of not more than the date stipulated in the Disclosure Statement, which term shall start from the date of the Borrowers’ receipt of the Loan, or any portion thereof.</p>

					<p class="termandcondition__subtitle">4. DUE DATE</p>
					<p>The expiration of the Loan Term shall be on the date stipulated in the Disclosure Statement (the “Due Date/Payment Date/Pay Day”).</p>
					...
					<p class="termandcondition__subtitle">5. LOAN TERM EXTENSION</p>
					<p>The Loan Term may be extended subject to additional terms and conditions set by the Lender, such as, but not limited to, the following:</p>
					<p>a. The Borrower shall request for an extension of the Loan Term from the Lender on or before the Due Date.</p>
					<p>b. The Borrower requesting for an extension of the Loan Term must have paid more at least Forty Percent (40%) of the Loan;</p>
					<p>c. Every request for extension of the loan term shall not exceed Thirty (30) days from Due Date;</p>
					<p>d. The Borrower shall pay additional fees, charges, and/or interests (the “Loan Term Extension Fees”);</p>
					<p>e. If the Borrower requests for an extension of the loan term after Due Date, the extension of the loan term commences from the date the Borrower complies with all the terms and conditions under this Section.</p>
					...
					<p>b. The Borrower requesting for additional extension/s of the Loan Term must have paid more at least Forty Percent (40%) of the Loan amount counted from the Extended Due Date;</p>
					<p>c. Each additional request for extension of the loan term shall not exceed Thirty (30) days from the Extended Due Date;</p>
					<p>d. The Borrower shall pay the Loan Extension Fees for each request for extension of the loan term;</p>
					<p>e. If the Borrower requests for an additional extension of the loan term after the Extended Due Date, the extension of the loan term commences from the date the Borrower complies with all the terms and conditions under this Section.</p>

					<p class="termandcondition__subtitle">6. LOAN RELEASE</p>
					<p>The Loan shall be released to the Borrower through Bank Transfer to the Borrower's Bank Account. No release under the Loan shall be made unless the Borrower complies with all the conditions required by the Lender and the provisions of this Agreement. The Borrower’s receipt of the Loan, or any portion there of, shall signify his/her agreement to all the terms and conditions of the Agreement.</p>

					<p class="termandcondition__subtitle">7. PAYMENT</p>
					<p>The Borrower shall pay the Loan, including all applicable fees, charges, and/or interests, in full, on or before Due Date, without need of any further notice or demand from the Lender. The first time the Borrower fails to pay in full of the Loan on Due Date, the Lender may grant the Borrower a one-time grace period of three (3) days within which to pay the Loan, or the balance thereof.</p>
					<p>All payments to be made by the Borrower under this Agreement shall be paid to the Lender not later than 7:00pm of the Due Date of the payment. Any payment made by the Borrower after such time shall be considered as payment made for the next working day, and shall be subject to applicable fees and charges.</p>

					<p class="termandcondition__subtitle">8. FEES AND CHARGES</p>
					<p>The Borrower shall, for his/her own account, pay all reasonable costs, charges, fees, and/or expenses incurred in connection with the release of the Loan, and any other documentation required there under and/or any amendment of the Agreement, which total reasonable costs, charges, fees, and/or expenses may include a service fee, processing fee, documentary stamp tax, and other legal fees.</p>
					<p>The Borrower shall also reimburse the Lender on demand for all reasonable and documented expenses incurred by them, including reasonable expenses and fees of external counsel, when applicable, (i) in connection with the enforcement and administration of the Loan Agreement from and after the occurrence of an Event of Default (as defined in the Section XVI of this Agreement), or (ii) with respect to any action which may be instituted by any person against the Lender in respect of any of the foregoing or as a result of any transaction, action or non-action arising from the foregoing. Such expenses shall be reimbursed whether or not the Lender gives notice of such Event of Default or demand acceleration of the Loan or take other action to enforce the provisions of this Agreement, unless the Lender waives the Event of Default and in such waiver specifically waive reimbursement of administration and enforcement expenses resulting from such waived Event of Default; provided that in every case the Borrower shall have the right to contest prior to or after the payment thereof the correctness or reasonableness of the expenses incurred.</p>
					<p>It is understood that expenses shall not include representation expenses of any kind.</p>
					<p>All applicable fees, charges, and/or interests on the Loan shall be indicated in the Disclosure Statement.</p>

					<p class="termandcondition__subtitle">9. INTEREST</p>
					<p>The Borrower agrees to pay the Lender interest on the Loan, or the balance there of, if applicable, at the rate of One Percent (1%), per Day. For the overdue payment interest is three Percent (3%)</p>

					<p class="termandcondition__subtitle">10. CASH DEPOSIT</p>
					<p>The Borrower agrees to pay the Lender Cash Deposit for the Loan, the cash deposit will be deducted over the loan amount, if borrower repay the loan on time, the Cash Deposit will return to the borrower (Deduct over the repayment amount)</p>

					<p class="termandcondition__subtitle">11. LATE PAYMENT FEE</p>
					<p>If the Borrower fails to pay full amount of loan, and other applicable fees, charges, and/or interests, to the Lender on Due Date, or at an earlier date by acceleration or otherwise, without a Loan Term Extension, the Borrower agrees and understands that he/she shall be liable unconditionally to pay, without prior written notice from the Lender, the cash deposit won’t be returned for a late payment, payable together with and in addition to the principal amount of the Loan and other applicable fees, charges, and/or interests due.</p>
					<p>The Borrower agrees and understands that he/she shall likewise be charged additional late payment fee should he/she fail to pay the Loan in full within Three (3), calendar days from Due Date, and a further late payment fee should he/she fail to pay the Loan in full within Ten (10), Twenty (20) and Thirty (30) calendar days from Due Date.</p>

					<p class="termandcondition__subtitle">12. LOAN TERM EXTENSION FEE</p>
					<p>If a Loan Term Extension is granted to the Borrower’s Loan, the Borrower agrees and understands that he/she shall pay the Lender a Loan Term Extension Fee equivalent to Forty Percent (40%) of the unpaid Loan, including applicable fees, charges, and/or interests. The Loan Term Extension Fee shall be charged to, and shall be paid by, the Borrower on the Extended Due Date, in accordance with the application of payment described in Section XI of this Agreement.</p>

					<p class="termandcondition__subtitle">13. APPLICATION OF PAYMENT</p>
					<p>Any payment made by the Borrower to the Lender shall be applied in the following order:</p>
					...
					<p class="termandcondition__subtitle">17. EVENT OF DEFAULT</p>
					<p>Without prejudice to any other terms in the Loan Agreement and the Lender’s right to demand immediate repayment of the Loan which is repayable on demand, the Borrower shall immediately repay, on demand, and without need for notice or demand from the Lender, the Loan, and applicable charges and fees, which are outstanding and unpaid, and all other expenses and moneys payable in relation to the Loan, upon any of the following events of default happening (the “Events of Default”):</p>
					<p>a. any other money that the Borrower owes the Lender under the Loan is not paid when due;</p>
					<p>b. The Borrower fails to pay on the due date in any amount that the borrower must pay under this Agreement or does not comply with any obligation of the Borrower under this Agreement or any guarantee document.</p>
					...
					<p>k. If a court of competent jurisdiction issues a judgment or decision against the Borrower; or an arbitration body of competent jurisdiction issues an award against the Borrower;</p>
					...
					<p class="termandcondition__subtitle">18. CONSEQUENCES OF DEFAULT</p>
					<p>Upon occurrence of an Event of Default, the Lender may, at its sole discretion, without need of notice or demand, and without limiting the Lender’s rights under applicable laws or under the Agreement:</p>
					...
					<p class="termandcondition__subtitle">23. TERMINATION</p>
					<p>The Borrower may terminate the Loan by giving the Lender written notice of such termination and by paying all monies owing under the Loan and these Terms and Conditions together with all fees, charges, and/or interests, if any.</p>
					...
					<p class="termandcondition__subtitle">24. ATTORNEY’S FEES</p>
					<p>If the Lender shall require the services of a legal counsel to enforce any of its rights and remedies under this Agreement, the Lender shall be entitled to recover from the Borrower, as attorney’s fees, a sum equal to One Hundred PERCENT (100.00 %) of the sum sought to be recovered, which in no case shall be less than Two Thousand Five Hundred PESOS (PhP 2,500.00), in addition to costs of suit, and all other fees, charges, and/or interests incurred by and reimbursable to the LENDER by the BORROWER.</p>

					<p class="termandcondition__subtitle">25. OTHER TERMS AND CONDITIONS</p>
					<p>a. ASSIGNMENT. The Lender may assign or transfer any or all its rights in this Agreement without the Borrower’s consent. The Borrower may not assign or transfer any of his/her rights under this Agreement without the Lender’s prior written consent.</p>
					<p>b. NON-EXCLUSIVITY. No right or remedy conferred upon or reserved to either party herein is exclusive of any other right or remedy herein, or that provided or permitted by law or equity; but each shall be cumulative of any other right or remedy available to such party under this Agreement and existing laws.</p>
					<p>c. COMPLETE AGREEMENT. This Agreement constitutes the entire agreement between the parties and shall supersede any and all prior or contemporaneous agreements between them, whether written or oral. No amendment of this Agreement shall be valid unless made in writing and signed by the parties.</p>
					<p>d. AMENDMENT. To the extent not contrary to applicable laws and regulations, the Lender may, at any time, at its absolute discretion and upon notice, whether in written form or otherwise, to the Borrower, change any one or more terms and conditions under this Agreement, as well as changing the loan details in the Loan Agreement, including but not limited to: the loan amount, interest rate, installment amount, installment due date. Such change/s shall take effect from the date stated in the notice. If the Borrower is not agreeable to such amendments, the Borrower must terminate the Loan Agreement by written notice to the Lender before the said effective date, and all sums owing and charges, if any, by the Borrower with respect to the Loan and these Terms and Conditions shall be paid to the Lender in full. The continued use of the Loan by the Borrower, notwithstanding the notice, shall automatically deemed to be an implied agreement to the amendments.</p>
					<p>e. BINDING ON SUCCESSORS AND ASSIGNS. This Agreement is binding on the parties and their respective successors-in-interest and assigns.</p>
					<p>f. INDULGENCE NOT WAIVER. The failure of either party to insist upon a strict performance of any of the terms, conditions and covenants of this Agreement shall not be deemed a relinquishment or waiver of such breach or default unless such waiver is in writing and signed by the authorized representative of the party making the waiver.</p>
					...
					<p>h. GOVERNING LAW. This Agreement shall be governed by and construed in all respects according to the laws of the Philippines.</p>
					<p>i. VENUE. The parties expressly agree to submit themselves exclusively to the jurisdiction of the courts of Makati City on any action or dispute arising out of this Agreement.</p>
					<p>j. OUTSOURCING. The Borrower agrees and allows the Lender to outsource the management and/or collection of debt as well as the litigation process to a third party, at the sole discretion of the Lender.</p>
					<p>k. ELECTRONIC SIGNATURES. The Lender is hereby authorized to rely upon and accept as an original any document or other communication which is sent to the Lender by facsimile, telegraphic or other electronic transmission, which the Lender in good faith believes has been signed by the Borrower and has been delivered to the Lender. Notwithstanding the foregoing, the Lender shall not be obligated to accept any such document or communication as an original and may in any instance require that an original document be submitted to the Lender in lieu of, or in addition to, any such document or communication.</p>
					<p>The signatures to this Agreement shall be as valid as an original signature of such party and shall be effective to bind such party to this Agreement.</p>
					<p>l. CHANGE IN NAME. The Change of the Business Name of the Lender for any reason, in all cases, shall not lead to the termination of this Agreement and the Borrower must comply with its obligations under the provisions of this Agreement.</p>
					<p>2. ACCEPTANCE. The Borrower confirms having read and understood and agrees to the entire Terms and Conditions constituting of above clauses. The Terms and Conditions and the other documents, such as the Disclosure Statement, have been explained to the Borrower in the language understood by the Borrower. The Borrower is aware that the Lender has agreed to grant a loan to the Borrower only after the Borrower has agreed to abide by the terms of this Agreement.</p>
...
<style lang="scss" src="../assets/css/terms.css" scoped>
